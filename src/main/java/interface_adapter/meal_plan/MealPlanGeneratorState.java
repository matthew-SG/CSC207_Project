...
public class MealPlanGeneratorState {
    ...
    public String getTargetCarbs() {
        return targetCarbs;
    }

    public void setTargetCarbs(String targetCarbs) {
        this.targetCarbs = targetCarbs;
    }

    public String getTargetFats() {
        return targetFats;
    }

    public void setTargetFats(String targetFats) {
    ...
    public String getInsufficientRecipesError() {
        return insufficientRecipesError;
    }
    ...
    public String getNoMealPlansError() {
        return noMealPlansError;
    }
