...
public class AppBuilder {
        ...
        // private UserDataAccess userDataAccessObject = new
        ...
        /**
         * Initialize the builder with custom DAO.
         *
         * @param approveRecipeDAO the DAO to use for approve recipe functionality
         */
        public AppBuilder(ApproveRecipeDataAccessInterface approveRecipeDAO) {
                if (approveRecipeDAO != null) {
                        this.approveRecipeDataAccessObject = approveRecipeDAO;
                }
        ...
        private void initializeViewManagerAndLayouts() {
                ...
                // Use FileDataAccessObject as the approve recipe DAO if not injected
                if (approveRecipeDataAccessObject == null) {
                        if (userDataAccessObject instanceof FileDataAccessObject) {
                                ...
                                throw new RuntimeException(
                                                "UserDataAccessObject must be FileDataAccessObject "
                                                                + "for approve recipe functionality");
                        }
                }
        ...
        public AppBuilder buildRecipeGeneratorFeature() {
                RecipeGeneratorViewModel recipeGeneratorViewModel = new RecipeGeneratorViewModel();

                // Presenter
                RecipeGeneratorOutputBoundary recipeGeneratorPresenter = new RecipeGeneratorPresenter(
                                recipeGeneratorViewModel, viewManagerModel);

                RecipeDataAccessInterface recipeGateway = new RecipeDataAccessObject();

                // interactor - pass FileDataAccessObject for approve recipe functionality
                RecipeGeneratorInputBoundary recipeGeneratorInteractor = new RecipeGeneratorInteractor(recipeGateway,
                                recipeGeneratorPresenter,
                                (FileDataAccessObject) userDataAccessObject);

                // Controller
                RecipeGeneratorController recipeGeneratorController = new RecipeGeneratorController(
                                recipeGeneratorInteractor);

                // View
                RecipeGeneratorView recipeGeneratorView = new RecipeGeneratorView(
         ...
         * Sets up all views, controllers, and use cases related to the community review
         * feature.
         *
         * @return this builder for method chaining
         */
        ...
        public AppBuilder buildMealPlan() {
                ...
                final ViewMealPlansInputBoundary viewMealPlansInteractor = new ViewMealPlansInteractor(
                                userDataAccessObject,
                                viewMealPlansPresenter);
                final LoadMealPlanOutputBoundary loadMealPlanPresenter = new LoadMealPlanPresenter(
                                mealPlanGeneratedViewModel,
                                viewManagerModel);
                final LoadMealPlanInputBoundary loadMealPlanInteractor = new LoadMealPlanInteractor(
                                userDataAccessObject,
                                loadMealPlanPresenter);
                final DeleteMealPlanOutputBoundary deleteMealPlanPresenter = new DeleteMealPlanPresenter(
                                viewMealPlansViewModel);
                final DeleteMealPlanInputBoundary deleteMealPlanInteractor = new DeleteMealPlanInteractor(
                                userDataAccessObject,
                ...
                DeleteMealPlanController deleteMealPlanController = new DeleteMealPlanController(
                                deleteMealPlanInteractor);
        ...
        public AppBuilder buildSearchByIngredient() {
                ...
                SearchByIngredientViewModel searchByIngredientViewModel = new SearchByIngredientViewModel();

                SearchByIngredientOutputBoundary searchByIngredientPresenter = new SearchByIngredientPresenter(
                                viewManagerModel, searchByIngredientViewModel);
                ...
                searchByIngredientView = new SearchByIngredientView(searchByIngredientViewModel,
